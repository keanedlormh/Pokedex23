...
const SG10TY = {
    ...
    "attributes": {
        ...
        "dim_principal_mm": "1446,0 x 150,0 x 32,5",
        "dim_subwoofer_mm": "180 x 394 x 290",
        "peso_principal_kg": "3,9",
        "peso_subwoofer_kg": "5,8",
        "peso_bruto_kg": "16,1",
        "con_hdmi_in": "1",
        "con_hdmi_out": "1",
        "con_usb": "1",
...
if (window.APP_DB && typeof window.APP_DB.registerProduct === 'function') {
    window.APP_DB.registerProduct(SG10TY);
} else {
