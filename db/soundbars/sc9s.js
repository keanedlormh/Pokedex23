...
const SC9S = {
    ...
    "attributes": {
        "general_num_canales": "3.1.3",
        "general_potencia_salida_w": "400",
        "general_num_altavoces": "9",
        "dim_principal_mm": "975 x 63 x 125",
        "dim_subwoofer_mm": "221 x 390 x 313",
        "peso_principal_kg": "4,1",
        "peso_subwoofer_kg": "7,8",
        "peso_bruto_kg": "22,7",
        "potencia_consumo_stb_principal_w": "0.5",
        "potencia_consumo_principal_w": "37",
        "potencia_consumo_stb_subwoofer_w": "0.5",
        "potencia_consumo_subwoofer_w": "38",
        "con_hdmi_in": "1",
        "con_hdmi_out": "1",
        "con_usb": "1",
        "con_optica": "1",
        "con_bluetooth_version": "5.0",
...
if (window.APP_DB && typeof window.APP_DB.registerProduct === 'function') {
    window.APP_DB.registerProduct(SC9S);
} else {
