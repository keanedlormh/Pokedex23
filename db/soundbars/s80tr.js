...
const S80TR = {
    ...
    "attributes": {
        "general_num_canales": "5.1.3",
        "general_potencia_salida_w": "580",
        "general_num_altavoces": "9",
        "dim_principal_mm": "1000 x 63 x 135",
        "dim_subwoofer_mm": "201,7 x 407 x 403",
        "dim_traseros_mm": "100,0 x 176,5 x 120,0",
        "peso_principal_kg": "4,3",
        ...
        "info_ean": "8806096055014",
        "info_eco_certificado": "UL/SGS/EnergyStar"
    }
};

// --- REGISTRO ---
if (window.APP_DB && typeof window.APP_DB.registerProduct === 'function') {
    window.APP_DB.registerProduct(S80TR);
} else {
